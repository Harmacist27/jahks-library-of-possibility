...
- <span >5
  ...
  Saving Throw or take 4d6 thunder damage. On a successful save,
  creatures take half damage. </span>
...
- <span >This
  ...
  this way 3 times per daily dawn.</span>
...
- <span >This
  ...
  take the damage, you gain vulnerability to fire damage, your speed is
  reduced to 0, and you are incapacitated. These effects, including any
  remaining temporary hit points, all end at the end of your next turn
  or when the temporary hit points are depleted.</span>
...
- <span >Once
  ...
  disappears after 8 hours or immediately after it takes any
  damage.</span>
...
- <span >The
  ...
  the blades are not spinning, the damage of the axe is only 1d8
  ...
  Proficiency in either tool reduces this time to 1 minute.</span>
...
- <span >This
  ...
  tool reduces this time to 1 minute.</span>
...
- <span >This
  ...
  This effect is blocked by the shield spell.</span>
...
- <span >This
  ...
  see within range. The cube can be used once per daily dawn. Putting
  all the same colored squares on the same face of the cube requires a
  DC 18 intelligence check or 2 hours of experimentation and pondering.
  Once the cube has been solved, the user can choose the effect instead
  of rolling on the table. If the cube was solved and then thrown, its
  faces shuffle and it needs to be solved again before it can be used in
...
- <span >Flip
  ...
  Magic Surge is triggered on you.</span>
...
- <span >Curse:
  ...
  the "phantom hum" keeping you awake.</span>
...
- <span >This
  ...
  harp regains all expended charges at daily dawn. </span>
